...
**In progress:** Testing in Python — **Ch 1 done** ([course file](./courses/04-introduction-to-testing.md)). Full section folds in here at course completion.
...
- **Testing in Python** — **Ch 1 done**, course in progress. When complete, add: pytest structure,
